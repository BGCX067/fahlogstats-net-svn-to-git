...
HTMLparser is a high performance HTML parser that allows to parse (tokenize) HTML. 

An example of use is in Main.cs. By default majestic12.html will be used in testing and benchmarking.
