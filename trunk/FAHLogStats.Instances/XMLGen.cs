...
namespace FAHLogStats.Instances
{
    public static class XMLGen
    {
        ...
        public static String InstanceXml(String xslTransform, Base Instance)
        {
            ...
            DateTime CompleteTime = Instance.UnitInfo.TimeOfLastFrame;
            ...
            XMLOps.setXmlNode(xmlData, "Protein/Description", FAHLogStats.Helpers.ProteinData.DescriptionFromURL(Instance.CurrentProtein.Description));
